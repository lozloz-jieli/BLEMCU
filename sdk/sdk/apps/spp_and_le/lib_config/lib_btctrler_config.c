...
#else
const uint64_t config_btctler_le_features = LE_ENCRYPTION | LL_FEAT_DATA_LEN_EXT;
const int config_btctler_le_roles    = (LE_ADV | LE_SLAVE);
#endif
...
#if (TCFG_BLE_DEMO_SELECT == DEF_BLE_DEMO_CLIENT) || (TCFG_BLE_DEMO_SELECT == DEF_BLE_DEMO_AT_CLIENT)
// Master AFH
...
#elif (TCFG_BLE_DEMO_SELECT == DEF_BLE_DEMO_UPLAS_TRANS)
// Master AFH
const int config_btctler_le_afh_en = 0;
// LE RAM Control
