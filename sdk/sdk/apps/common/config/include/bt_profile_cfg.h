...
#if (TRANS_DATA_EN || RCSP_BTMATE_EN || RCSP_ADV_EN || SMART_BOX_EN || ANCS_CLIENT_EN || LL_SYNC_EN || UPLUS_TRANS_EN)
...
#define DEF_BLE_DEMO_UPLAS_TRANS          14 //
...
#elif UPLUS_TRANS_EN
#define TCFG_BLE_DEMO_SELECT          DEF_BLE_DEMO_UPLAS_TRANS
